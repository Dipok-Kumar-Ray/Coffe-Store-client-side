...
const UpdateCoffee = () => {
    ...
    return (
          <div className='p-24'>
            ...
            <form onSubmit={handleUpdeteCoffee}>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                     <label className="label">Name</label>
                    <input type="text" name='name' defaultValue={name} className="input w-full" placeholder="Coffe Name" />  
                    </fieldset>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                    ...
                    <input type="submit" className='btn w-full' value="Update Coffe" />
            </form>
        </div>
    );
};
